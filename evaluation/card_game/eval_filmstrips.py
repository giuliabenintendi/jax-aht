...
def _save_gt_strip(attn_maps, ep_actions, ep_states, viz_card_masks,
                   out_dir: Path, out_name: str) -> None:
    """Render and save one 2xT GT-frame coolwarm attention filmstrip PNG."""
    _log_card_game_gt_attn_filmstrip(
...
def main() -> None:
    ...
    def _run_block(tag: str, params_a, params_b, rng_offset: int) -> None:
        for ep in range(args.num_episodes):
            ...
            _save_gt_strip(attn_maps, ep_actions, ep_states, viz_card_masks,
                           out_dir, gt_out_name)
